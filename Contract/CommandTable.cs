namespace Polyfill.Contract
{
    ...
    internal static class CommandTable
    {
        ...
        internal static readonly Command[] All =
        {
            ...
            C("polyfillprobe",   "can the runtime resolve this type, and does Type::Member really run?",
                                 "polyfillprobe Il2CppScheduleOne.UI.InputPromptsCanvas::LoadModule objectselector"),
